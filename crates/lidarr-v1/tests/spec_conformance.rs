...
//! Lidarr OpenAPI request schemas.
//!
...
//! The lidarr schemas are `additionalProperties: false`, so a hallucinated,
...
use lidarr_v1::resources;

fn spec() -> Value {
    serde_json::from_str(include_str!("../spec/lidarr-v1.json")).expect("spec parses")
}
...
conformance!(
    ...
    resources::metadata_provider_config::MetadataProviderConfig,
    "MetadataProviderConfigResource",
    "testdata/metadata_provider_config/config.yaml"
);
