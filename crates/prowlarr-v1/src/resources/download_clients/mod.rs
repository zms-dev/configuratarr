//! Tagged-enum for Prowlarr download-client implementations. The discriminator is
...
//!
//! One file per variant under this directory. Variant list and field shapes are
//! sourced from the devopsarr/terraform-provider-prowlarr provider.
...
/// Discriminated union of all supported Prowlarr download-client implementations.
