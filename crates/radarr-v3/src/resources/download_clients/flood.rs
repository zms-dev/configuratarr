...
pub struct FloodConfig {
    ...
    /// Tags applied to the torrent in Flood (string labels, not Radarr tag ids)
    #[wire(name = "tags")]
    pub field_tags: Vec<String>,
    /// Additional Radarr-managed metadata tags appended to the torrent (integer codes).
    #[wire(name = "additionalTags")]
    pub additional_tags: Vec<i32>,
    /// Tags applied to the torrent in Flood after Radarr imports it.
