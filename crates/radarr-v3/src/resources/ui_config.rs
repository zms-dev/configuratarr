...
#[resource(
    ...
    update = put("/api/v3/config/ui/${self.id}"),
)]
pub struct UiConfig {
    #[id]
    pub id: Option<i32>,
    ...
    /// How movie runtimes are displayed in the UI: `hoursMinutes` or `minutes`.
    ...
    /// Language ID for displaying movie titles and metadata in the UI.
    pub movie_info_language: i32,
    /// Language ID for the Radarr UI interface itself.
    pub ui_language: i32,
