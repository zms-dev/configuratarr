//! End-to-end tests against a live Sonarr.
//!
...
//! by `SONARR_URL` + `SONARR_API_KEY`; `#[ignore]` by default.
//!
//! Run inside the e2e dev shell (starts Sonarr, exports the env vars):
//!   nix develop .#e2e-sonarr --command \
//!     cargo test -p sonarr-v3 --test e2e -- --ignored
...
/// `tags: ["${ref...}"]`, which Sonarr rejects (not an integer).
#[tokio::test]
#[ignore]
