...
//! client host to the corresponding local path visible to Sonarr.
...
#[resource(
    sync = crud,
    list = get("/api/v3/remotepathmapping"),
    create = post("/api/v3/remotepathmapping"),
    update = put("/api/v3/remotepathmapping/${self.id}"),
    delete = delete("/api/v3/remotepathmapping/${self.id}"),
)]
