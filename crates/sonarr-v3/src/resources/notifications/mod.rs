//! NotificationProvider — *arr provider enum. Each variant binds an `implementation`
...
/// Discriminated union of all supported Sonarr notification provider implementations.
