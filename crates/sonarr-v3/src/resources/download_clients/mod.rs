//! Tagged-enum for Sonarr download-client implementations. The discriminator is
...
//!
//! One file per variant under this directory, following the same pattern as the
//! canonical radarr-v3 template.
